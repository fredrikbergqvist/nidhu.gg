...
var _a, _NidhuggBackToTop_anchorId, _NidhuggBackToTop_anchorClass, _NidhuggBackToTop_scrollToId, _NidhuggBackToTop_endOfContentId, _NidhuggBackToTop_supportsScrollAnimation;
class NidhuggBackToTop extends HTMLElement {
    ...
    connectedCallback() {
        if (!this.getAttribute("scroll-id") || !__classPrivateFieldGet(this, _NidhuggBackToTop_supportsScrollAnimation, "f")) {
        ...
        const scrollToId = this.getAttribute("scroll-id") || __classPrivateFieldGet(this, _NidhuggBackToTop_scrollToId, "f");
...
_a = NidhuggBackToTop, _NidhuggBackToTop_anchorId = new WeakMap(), _NidhuggBackToTop_anchorClass = new WeakMap(), _NidhuggBackToTop_scrollToId = new WeakMap(), _NidhuggBackToTop_endOfContentId = new WeakMap(), _NidhuggBackToTop_supportsScrollAnimation = new WeakMap();
